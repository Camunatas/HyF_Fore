...
dataset_sotavento = pd.read_csv('Data/Sotavento Historical Data.csv', sep=';',parse_dates=['Date'], index_col="Date")
# Slicing data
...
# sm.graphics.tsa.plot_acf(dataset_raw.loc[df_day_start:df_day_end]['Speed'].astype(float).values, lags=55)
# plt.show()
# Plot partial correlations
# sm.graphics.tsa.plot_pacf(dataset_raw.loc[df_day_start:df_day_end]['Speed'].astype(float).values, lags=10)
# plt.show()
...
#%% Saving results
np.save('Windspe_pred.npy', Pgen_pred_dict)
#%% Plotting results
